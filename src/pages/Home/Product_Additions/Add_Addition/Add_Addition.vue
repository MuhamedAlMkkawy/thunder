        ...
        <form action="" @submit.prevent="handleSubmit">
          ...
          <div class="input">
            <input 
              ...
              @blur="body.ar_name = body.ar_name.trim()"
            >
          </div>
          ...
          <div class="input">
              <input 
                  ...
                  @blur="body.en_name = body.en_name.trim()"
              >
          </div>
          ...
          <div class="input">
              <input 
                  ...
                  @blur="body.ur_name = body.ur_name.trim()"
              >
          </div>
          ...
          <div class="input">
              <input 
                  ...
                  @blur="body.ar_description = body.ar_description.trim()"
              >
          </div>
          ...
          <div class="input">
              <input 
                  ...
                  @blur="body.en_description = body.en_description.trim()"
              >
          </div>
          ...
          <div class="input">
              <input 
                  ...
                  @blur="body.ur_description = body.ur_description.trim()"
              >
          </div>
          ...
          <div class="input">
              <input 
                  ...
                  v-model="body.price"
                  @blur="body.price = parseFloat(body.price).toFixed(2)"
              >
          </div>
          ...
          <div class="input">
              ...
              <label for="image" v-if="!localImage">
...
<script setup>
  ...
  const handleSubmit = () => {
    ...
    if (body.value.ar_name === '') {
      ...
      if (body.value.ar_name !== '' && body.value.ar_name.length < 2) {
        handleToast('error', 
    ...
    // Validate English Name
      ...
      if (body.value.en_name !== '' && body.value.en_name.length < 2) {
        handleToast('error', 
    ...
    // Validate Urdu Name
      ...
      if (body.value.ur_name !== '' && body.value.ur_name.length < 2) {
        handleToast('error', 
    ...
    // Validate Arabic Description
      ...
      if (body.value.ar_description !== '' && body.value.ar_description.length < 2) {
        handleToast('error', 
    ...
    // Validate English Description
      ...
      if (body.value.en_description !== '' &&body.value.en_description.length < 2) {
        handleToast('error', 
    ...
    // Validate Urdu Description
      ...
      if (body.value.ur_description !== '' &&body.value.ur_description.length < 2) {
        handleToast('error', 
      ...
      postMethod('provider/products-addons/store' , addition , true , '/product_additions' , 'success')
    }
  }
