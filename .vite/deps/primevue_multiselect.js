...
var script17 = {
  ...
  methods: {
    ...
    onOptionSelect: function onOptionSelect(event, option2) {
      ...
      else value = [].concat(_toConsumableArray4(this.modelValue || []), [this.getOptionValue(option2)]);
      this.updateModel(event, value);
      ...
      if (this.filterValue) {
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0) filtered.push(_objectSpread5(_objectSpread5({}, group), {}, _defineProperty$1({}, typeof _this25.optionGroupChildren === "string" ? _this25.optionGroupChildren : "items", _toConsumableArray4(filteredItems))));
          });
